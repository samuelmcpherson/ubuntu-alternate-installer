...
chroot $TEMPMOUNT /bin/bash -c "apt -y install zsh zsh-antigen wget git irssi lynx elinks lm-sensors net-tools screen tmux sysstat htop iotop glances ripgrep nmap iftop vim thermald tcpdump cups samba smartmontools make cmake build-essential libsystemd-dev pkg-config && echo '---> apt install zsh zsh-antigen wget git irssi lynx elinks lm-sensors net-tools screen tmux sysstat htop iotop glances ripgrep nmap iftop vim thermald tcpdump cups samba pv smartmontools make cmake build-essential libsystemd-dev pkg-config succeeded <--------------------------------------------------------------' || { echo 'apt install zsh zsh-antigen wget git irssi lynx elinks lm-sensors net-tools screen tmux sysstat htop iotop glances ripgrep nmap iftop vim thermald tcpdump cups samba pv smartmontools make cmake build-essential libsystemd-dev pkg-config failed'; exit 1; }" || exit 1
